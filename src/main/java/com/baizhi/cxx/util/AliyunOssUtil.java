...
public class AliyunOssUtil {
    ...
    private static String accessKeyId = "LTAI4FcajTRNQHdLfJbZocNc";
    private static String accessKeySecret = "F5lT1Xy5s6Orc22LSUE23a7yqak620";

    private static String bucket="yingx-186-cxx";
    ...
    * */
     ...
     *   fileName:  指定上传文件名  可以指定上传目录：  目录名/文件名
     * */
    public static void uploadFileBytes(String bucket,MultipartFile path, String fileName){
